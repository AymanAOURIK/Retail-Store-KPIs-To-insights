...
- The workbook used in this public repo should be described as synthetically generated sample data for demo purposes.
...
- The synthetic sample workbook still exists locally for app execution and analyst work.
